...
def upgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['facilitador_id'], ['users.id'], ),
    ...
    sa.ForeignKeyConstraint(['sesion_id'], ['sesiones_capacitacion.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    op.create_table('respuestas_empleado',
    sa.Column('id', sa.UUID(), nullable=False),
