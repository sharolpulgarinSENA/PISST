...
class Incidente(Base):
    ...
    investigacion = relationship(
        "Investigacion", back_populates="incidente", uselist=False
    )
    acciones_correctivas = relationship("AccionCorrectiva", back_populates="incidente")

    __table_args__ = (Index("ix_incidentes_empresa_estado", "empresa_id", "estado"),)
